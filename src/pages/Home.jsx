...
const Home = () => {
  ...
  // While Firebase resolves auth state, show nothing to avoid nav flicker
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              {user ? (
                ...
                <Link
                  to="/dashboard"
                  className="flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-bold bg-[#0D9488] hover:bg-teal-700 text-white shadow-sm transition-all transform hover:-translate-y-0.5"
                >
        ...
        <div className="flex flex-col space-y-24 py-12 animate-fade-in">
          ...
          <section className="max-w-6xl mx-auto px-4 w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="clinical-card p-8 flex flex-col items-start text-left space-y-4 hover:shadow-md transition-shadow">
                <div className="p-3 bg-teal-50 rounded-xl text-[#0F766E]"><Camera size={32} /></div>
              ...
              <div className="clinical-card p-8 flex flex-col items-start text-left space-y-4 hover:shadow-md transition-shadow">
                <div className="p-3 bg-teal-50 rounded-xl text-[#0F766E]"><Activity size={32} /></div>
              ...
              <div className="clinical-card p-8 flex flex-col items-start text-left space-y-4 hover:shadow-md transition-shadow">
                <div className="p-3 bg-teal-50 rounded-xl text-[#0F766E]"><TrendingUp size={32} /></div>
          ...
          <section className="max-w-5xl mx-auto px-4 w-full text-center space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              <div className="hidden md:block absolute top-12 h-0.5 bg-slate-200 z-0" style={{ left: '16.6%', right: '16.6%' }} />

              <div className="relative z-10 flex flex-col items-center space-y-4">
                <div className="w-24 h-24 rounded-full bg-white border-4 border-slate-100 shadow-sm flex items-center justify-center text-3xl font-black text-[#0F766E]">1</div>
                <h4 className="text-xl font-bold text-slate-800">Create Account</h4>
                <p className="text-slate-500 max-w-xs">Sign up free with your email or Google account — no credit card required.</p>
              </div>

              <div className="relative z-10 flex flex-col items-center space-y-4">
                <div className="w-24 h-24 rounded-full bg-white border-4 border-slate-100 shadow-sm flex items-center justify-center text-3xl font-black text-[#0F766E]">2</div>
                <h4 className="text-xl font-bold text-slate-800">Position &amp; Track</h4>
                <p className="text-slate-500 max-w-xs">Enable your webcam and stand back. The AI tracks your joints live, counting reps and grading form in real-time.</p>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center space-y-4">
                ...
                <p className="text-slate-500 max-w-xs">Sessions are saved automatically. View angle trends and compliance reports on your personal dashboard.</p>
              </div>
            </div>

            {/* Bottom CTA — adapt to auth state */}
            <div className="pt-4">
              {user ? (
                <Link
                  to="/dashboard"
